...
namespace Internship2024
{
	...
	public class pl_decimal
	{
		...
		public pl_decimal(InternTaskDbContext db)
		{
			_db = db;
		}
		...
		{
			return _db.CreateCommand("dbo.pl_decimal_GetAll", true);
		}
        ...
        public virtual bool Update(pl_decimalRow value)
        {
            SqlCommand cmd = _db.CreateCommand("dbo.pl_decimal_Update", true);
            AddParameter(cmd, "Table_pid",
                value.IsTable_pidNull ? DBNull.Value : (object)value.Table_pid);
            AddParameter(cmd, "Column_type", value.Column_type);
            AddParameter(cmd, "Data_value",
