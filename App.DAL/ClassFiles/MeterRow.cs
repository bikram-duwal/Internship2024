// <fileinfo name="MeterRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="MeterRow"/> that 
	/// represents a record in the <c>Meter</c> table.
	/// </summary>
	/// <remarks>
	...
	public class MeterRow
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MeterRow"/> class.
		/// </summary>
		public MeterRow()
		{
			// EMPTY
		...
		/// <summary>
		/// Gets or sets the <c>ShortName</c> column value.
		/// </summary>
		/// <value>The <c>ShortName</c> column value.</value>
