...
namespace Internship2024
{
	...
	public class Meter
	{
		...
		{
			return _db.CreateCommand("dbo.Meter_GetAll", true);
		}
		...
		{
			SqlCommand cmd = _db.CreateCommand("dbo.Meter_Insert", true);
		...
		{
			return _db.CreateCommand("dbo.Meter_DeleteAll", true).ExecuteNonQuery();
		}
