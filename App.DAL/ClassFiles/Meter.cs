// <fileinfo name="MeterCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="MeterCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="MeterCollection"/>
	...
	public abstract class Meter
	{
		...
		/// <summary>
		/// Gets an array of all records from the <c>Meter</c> table.
		/// </summary>
		/// <returns>An array of <see cref="MeterRow"/> objects.</returns>
		public virtual MeterRow[] GetAll()
		{
		...
		/// includes all records from the <c>Meter</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>Meter</c> table.
		/// </summary>
		...
		{
			return _db.CreateCommand("dbo._Meter_GetAll", true);
		}

		/// <summary>
		/// Gets the first <see cref="MeterRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="MeterRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public MeterRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			MeterRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="MeterRow"/> objects that 
		...
		/// <returns>An array of <see cref="MeterRow"/> objects.</returns>
		public MeterRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="MeterRow"/> objects.</returns>
		public virtual MeterRow[] GetAsArray(string whereSql, string orderBySql,
		...
		/// <summary>
		/// Gets <see cref="MeterRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="MeterRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual MeterRow GetByPrimaryKey(long id)
		{
			SqlCommand cmd = _db.CreateCommand("dbo._Meter_GetByPrimaryKey", true);
			AddParameter(cmd, "ID", id);
			MeterRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Adds a new record into the <c>Meter</c> table.
		/// </summary>
		/// <param name="value">The <see cref="MeterRow"/> object to be inserted.</param>
		public virtual void Insert(MeterRow value)
		{
			SqlCommand cmd = _db.CreateCommand("dbo._Meter_Insert", true);
			AddParameter(cmd, "UniqueCode", value.UniqueCode);
			AddParameter(cmd, "Name", value.Name);
			AddParameter(cmd, "ShortName", value.ShortName);
		...
		/// <summary>
		/// Updates a record in the <c>Meter</c> table.
		/// </summary>
		/// <param name="value">The <see cref="MeterRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(MeterRow value)
		{
			SqlCommand cmd = _db.CreateCommand("dbo._Meter_Update", true);
			AddParameter(cmd, "UniqueCode", value.UniqueCode);
			AddParameter(cmd, "Name", value.Name);
			AddParameter(cmd, "ShortName", value.ShortName);
			AddParameter(cmd, "Details1", value.Details1);
		...
		/// <summary>
		/// Updates the <c>Meter</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>Meter</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>Meter</c> table.
		/// </summary>
		/// <param name="value">The <see cref="MeterRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(MeterRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>Meter</c> table using
		...
		{
			SqlCommand cmd = _db.CreateCommand("dbo._Meter_DeleteByPrimaryKey", true);
			AddParameter(cmd, "ID", id);
			return 0 < cmd.ExecuteNonQuery();
		}

		/// <summary>
		/// Deletes <c>Meter</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>Meter</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.SqlCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[Meter]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>Meter</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		public int DeleteAll()
		{
			return _db.CreateCommand("dbo._Meter_DeleteAll", true).ExecuteNonQuery();
		}
		...
		/// <returns>An array of <see cref="MeterRow"/> objects.</returns>
		protected MeterRow[] MapRecords(SqlCommand command)
		{
		...
		/// <returns>An array of <see cref="MeterRow"/> objects.</returns>
		protected MeterRow[] MapRecords(SqlDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="MeterRow"/> objects.</returns>
		protected virtual MeterRow[] MapRecords(SqlDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			int shortNameColumnIndex = reader.GetOrdinal("ShortName");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					...
					record.ShortName = Convert.ToString(reader.GetValue(shortNameColumnIndex));
			...
			return (MeterRow[])(recordList.ToArray(typeof(MeterRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="MeterRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="MeterRow"/> object.</returns>
		protected virtual MeterRow MapRow(DataRow row)
		{
			MeterRow mappedObject = new MeterRow();
			...
			// Column "ShortName"
			dataColumn = dataTable.Columns["ShortName"];
			if(!row.IsNull(dataColumn))
				mappedObject.ShortName = (string)row[dataColumn];
			// Column "Details1"
		...
		protected virtual DataTable CreateDataTable()
		{
			...
			dataColumn.AllowDBNull = false;
			dataColumn = dataTable.Columns.Add("ShortName", typeof(string));
			dataColumn.MaxLength = 100;
			dataColumn.AllowDBNull = false;
	...
	} // End of MeterCollection_Base class
}  // End of namespace
