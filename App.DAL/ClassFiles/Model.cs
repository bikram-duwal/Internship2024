...
namespace Internship2024
{
	...
	public class Model
	{
		...
		{
			return _db.CreateCommand("dbo.Model_GetAll", true);
		}
		...
		{
			SqlCommand cmd = _db.CreateCommand("dbo.Model_Insert", true);
		...
		{
			return _db.CreateCommand("dbo.Model_DeleteAll", true).ExecuteNonQuery();
		}
