...
namespace Internship2024
{
	...
	public class EquipmentType
	{
		...
		{
			return _db.CreateCommand("dbo.EquipmentType_GetAll", true);
		}
		...
		{
			SqlCommand cmd = _db.CreateCommand("dbo.EquipmentType_Insert", true);
		...
		{
			return _db.CreateCommand("dbo.EquipmentType_DeleteAll", true).ExecuteNonQuery();
		}
