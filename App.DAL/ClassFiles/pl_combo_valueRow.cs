...
namespace Internship2024
{
	...
	public class pl_combo_valueRow
	{
		...
		/// <summary>
		/// Gets or sets the <c>combo_value</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>combo_value</c> column value.</value>
		public string Combo_value
		{
			get { return _combo_value; }
			set { _combo_value = value; }
		}
