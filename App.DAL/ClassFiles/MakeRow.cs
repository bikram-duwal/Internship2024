...
{
	/// <summary>
	/// The base class for <see cref="MakeRow"/> that 
	/// represents a record in the <c>Make</c> table.
	/// </summary>
	/// <remarks>
	...
	public class MakeRow
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MakeRow"/> class.
		/// </summary>
		public MakeRow()
		{
			// EMPTY
		...
		/// <summary>
		/// Gets or sets the <c>Caption</c> column value.
		/// </summary>
		/// <value>The <c>Caption</c> column value.</value>
		...
		/// <summary>
		/// Gets or sets the <c>DescriptionColumn</c> column value.
		/// </summary>
		/// <value>The <c>DescriptionColumn</c> column value.</value>
		...
		public override string ToString()
		{
			...
			dynStr.Append("  DescriptionColumn=");
			dynStr.Append(DescriptionColumn);
			return dynStr.ToString();
		}
	} // End of MakeRow_Base class
} // End of namespace
